...
> **说明（2026-09-20）**：本清单已整理至 [docs/tasks.md](../../../docs/tasks.md)（T-001~T-015），后续任务状态以 tasks.md 为准，本文件保留为原始记录，不再更新。
...
1. c错题记录按钮 getNewExamDetails,showErrorType为1,ishidenerrquestion为N
